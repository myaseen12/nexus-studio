        ...
        <ScrollReveal className="rounded-[2rem] border border-white/10 bg-slate-900/60 p-6 sm:p-8 backdrop-blur-xl dark:border-slate-200/70 dark:bg-white/80">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6 text-sm text-slate-100 dark:text-slate-900">
              ...
              <button
                type="submit"
                className="btn-premium-shimmer w-full rounded-full bg-cyan-400 py-3.5 font-semibold text-slate-950 transition hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(34,211,238,0.25)] dark:bg-slate-950 dark:text-white cursor-pointer"
              >
                Log Proposal & Save
              </button>
            </form>
